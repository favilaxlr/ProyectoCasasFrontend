...
const sections = [
  ...
  },
  {
    ...
    body: [
      ...
      'Request deletion of your account and associated data by contacting compliance@frfamilyinvestments.com.',
      ...
      <div className="max-w-4xl mx-auto bg-white shadow-xl rounded-3xl p-8 md:p-12 space-y-8">
        ...
        <section className="bg-blue-50 border border-blue-100 rounded-2xl p-6">
          <p className="text-sm text-blue-900">
            Questions? Email <a href="mailto:compliance@frfamilyinvestments.com" className="underline font-medium">compliance@frfamilyinvestments.com</a> or call +1 (469) 405-1309.
          </p>
        </section>
